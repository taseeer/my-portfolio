...
const EMAILJS_PUBLIC_KEY = 'H----iv3kU60tNv3p';  // Your public key from EmailJS
 ...
 const handleFormSubmit = (e) => {
  ...
  const certifications = [
    { name: "Google Cybersecurity Professional Certificate", issuer: "Google", icon: <Shield className="w-5 h-5" /> },
    { name: "Google Project Management Certificate", issuer: "Google", icon: <Briefcase className="w-5 h-5" /> }
  ];
                ...
                <div className="relative overflow-hidden h-56">
                  ...
                  <div className="absolute top-4 left-4">
                    <div className="p-3 rounded-xl bg-white/90 backdrop-blur-sm shadow-lg">
                      <div style={{ color: '#0A2647' }}>{project.icon}</div>
                    </div>
                  </div>
